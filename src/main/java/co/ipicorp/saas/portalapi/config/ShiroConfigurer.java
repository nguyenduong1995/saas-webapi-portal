...
import co.ipicorp.saas.portalapi.security.ConsumerRealm;
...
public class ShiroConfigurer {
    ...
    public SimpleCookie sessionIdCookie() {
        SimpleCookie sessionIdCookie = new SimpleCookie(CustomerSessionInfo.APP_CUSTOMER_SESSION_ID_KEY);
    ...
    @Bean
    public ConsumerRealm appRealm() {
        ConsumerRealm mlmsRealm = new ConsumerRealm();
        return mlmsRealm;
    }

 ...
 * @version    1.0.0
 */
package co.ipicorp.saas.portalapi.config.persistence;

import co.ipicorp.saas.nrms.web.config.persistence.CurrentTenantIdentifierResolverImpl;
import co.ipicorp.saas.nrms.web.config.persistence.CustomerDataSourceLookup;
import co.ipicorp.saas.nrms.web.config.persistence.MultiTenantConnectionProviderImpl;
...
//        properties.put("hibernate.enable_lazy_load_no_trans", "true");
        ...
        properties.put("hibernate.multi_tenant_connection_provider", multitenancyConnectionProvider());
    ...
    @Bean
    public CustomerDataSourceLookup datasourceLookup() {
        return new CustomerDataSourceLookup();
    }

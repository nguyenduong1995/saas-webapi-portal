...
import co.ipicorp.saas.portalapi.interceptor.CustomerIdentifierInterceptor;
...
public class SpringMvcConfigurer implements WebMvcConfigurer {
    ...
    @Bean
    public AppAuthenticationInterceptor appAuthInterceptor() {
    ...
    @Bean
    public CustomerIdentifierInterceptor customerIdentifierInterceptor() {
        return new CustomerIdentifierInterceptor();
    }
    
    @Override
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(customerIdentifierInterceptor());

 ...
 * @access public
 */
public class RetailerInvoiceInfoCreationForm implements Serializable {
    ...
    public String toString() {
        return "RetailerInvoiceInfoForm [retailerId=" + retailerId + "retailerInvoiceName=" + retailerInvoiceName + ", taxNo=" + taxNo  

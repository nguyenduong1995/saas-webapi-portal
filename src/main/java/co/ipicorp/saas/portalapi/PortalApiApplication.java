 ...
 * 
 */
package co.ipicorp.saas.portalapi;

import co.ipicorp.saas.portalapi.config.ShiroConfigurer;
...
@ComponentScan(basePackages = {"co.ipicorp.saas.portalapi", "co.ipicorp.saas.core", "co.ipicorp.saas.nrms", "grass.micro.apps"})
